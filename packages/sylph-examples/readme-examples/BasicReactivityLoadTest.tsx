      ...
      <container>
        <container>
          <text
            zIndex={1}
            x={1000}
            style={{ wordWrap: true, wordWrapWidth: 500 }}
          >
            This demo shows {props.activeCount} individual sprites being
            rendered and updated in real time using basic solid primitives and a
            coroutine to animate scale with different easing functions.
          </text>
...
export const BasicReactivityLoadTest = () => {
  ...
  const entityList = Array.from({ length: SPRITE_MAX }, (_) =>
