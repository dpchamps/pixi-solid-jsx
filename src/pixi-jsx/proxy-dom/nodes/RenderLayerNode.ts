...
> {
    ...
    addChildProxy(child: ProxyDomNode, anchor: ProxyDomNode | undefined): void | ProxyDomNode {
        if(child.tag !== "render-layer" && child.tag !== "raw" && child.tag !== "application" && child.tag !== "html"){
