import {ProxyDomNode} from "./Node.ts";
...
export const isNodeWithPixiContainer = <Node extends ProxyDomNode>(node: Node): node is Extract<Node, {tag: "container" | "sprite" | "text" | "graphics"}> => {
    switch(node.tag){
        case "container":
        case "text":
        case "graphics":
