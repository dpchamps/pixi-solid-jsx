...
const childWithSpacing = (
    ...
    switch (orientation){
        case "horizontal": return childWithHorizontalSpacing(el, i, parentBoxModel, acc);
        case "vertical": return childWithVerticalSpacing(el, i, parentBoxModel, acc);
        default: return unreachable(orientation)
    }
}
...
export const FlexBox = (props: JSX.PixieNodeProps<FlexBoxProps>) => {
    ...
    createEffect(() => {
        ...
        }, {elements: [] as AnyProxyNode[], maxX: 0, maxY: 0, row: 0, col: 0, width: 0, height: 0})
    })
