...
export type FlexBoxOrientation =
    | "vertical"
    | "horizontal"
...
export type SpacingFnState = Pick<FlexBoxChildrenState, "maxX" | "maxY" | "row" | "col" | "width" | "height">;

export type SpacingFn = (el:AnyProxyNode, index: number, parentBoxModel: BoxModel, acc: SpacingFnState) =>
